                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="<?php echo base_url() ?>assets/smartadmin/img/logo.png" width="28" height="28" alt="ePNBP" aria-roledescription="logo">
                            <span class="page-logo-text mr-1">ePNBP</span>
